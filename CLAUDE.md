...
- `sections/waggly-story.liquid` — reusable rich‑text/quote band (eyebrow, heading, richtext body, optional left/right image, centered‑quote mode). Used by the content pages below.
